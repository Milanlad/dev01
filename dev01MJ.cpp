...
void print_all_info(float moyenne,char best_prenom[99],worst_prenom[99],float best_note,float worst_note)
{
...
void name_check()
{
errorp = strcmp(error_prenom,prenom);
if (errorp ==0)
	{
	errorp = 1;
	}
...
print_all_info(moyenne,best_prenom,worst_prenom,best_note,worst_note);//Fait le print de : la moyenne , La pire note et son détenteur, La meilleur note et son détenteur.
}
